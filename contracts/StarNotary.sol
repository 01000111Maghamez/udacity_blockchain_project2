...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You must own at least one of the tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        // there is no need to check if sender if owner of _tokenId as the
        // current implemention of ERC721 from openzepplin does this already.
    }
